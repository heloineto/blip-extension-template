    ...
    return (
        <div className="flex flex-col gap-5 text-3xl">
            <div>
                ...
                <div className="font-light">Nunito Sans</div>
                <div className="font-normal">Nunito Sans</div>
                <div className="font-medium">Nunito Sans</div>
                <div className="font-semibold">Nunito Sans</div>
                <div className="font-bold">Nunito Sans</div>
                <div className="font-extrabold">Nunito Sans</div>
